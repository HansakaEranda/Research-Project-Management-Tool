...
const Register = () => {
    ...
    return (
        <div className="register">
            ...
            <input type="text" name="regNo" value={students.regNo} placeholder="Your Name" onChange={ handleChange }></input>
            <input type="text" name="stemail" value={students.stemail} placeholder="Your Email" onChange={ handleChange }></input>
            <input type="text" name="stuserName" value={students.stuserName} placeholder="Your Password" onChange={ handleChange }></input>
            <input type="password" name="stpwd" value={students.stpwd} placeholder="Re-enter Password" onChange={ handleChange }></input>
